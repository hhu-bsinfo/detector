...
// are only availabe with libibmad version 2.0 or higher. Most Linux distributions still ship with version 1.3.
// If you habe version 2.0 or higher installed, you can set this macro to 1.
